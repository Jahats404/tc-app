                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select id="status_booking" name="status_booking" class="form-control @error('status_booking') is-invalid @enderror">
                            ...
                            <option value="Diterima" {{ old('status_booking') == 'Diterima' ? 'selected' : '' }}>Diterima</option>
                            <option value="Ditolak" {{ old('status_booking') == 'Ditolak' ? 'selected' : '' }}>Ditolak</option>
                            <option value="Dibatalkan" {{ old('status_booking') == 'Dibatalkan' ? 'selected' : '' }}>Dibatalkan</option>
                        </select>
